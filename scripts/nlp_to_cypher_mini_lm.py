...
try:
    ...
    print("Warning: ML dependencies not installed. Run: pip install sentence-transformers scikit-learn spacy")

from neo4j import GraphDatabase


class QuestionEncoder:
    """Encodes questions into embeddings using sentence transformers"""
    ...
    def encode(self, texts):
        ...
        Returns:
            numpy array of embeddings (384-dim for MiniLM)
        """
...
class MLNLPToCypher:
    ...
    def __init__(self, neo4j_uri: str, neo4j_user: str, neo4j_password: str):
        ...
        self.entity_extractor = EntityExtractor(self.driver)
...
def main():
    ...
    try:
        ...
        # Save the model
        converter.save_model("models/intent_classifier.pkl")
